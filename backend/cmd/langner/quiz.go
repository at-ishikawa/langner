...
func runRecognitionQuiz(cfg *config.Config, openaiClient inference.Client, notebookName string, includeNoCorrectAnswers bool) error {
	...
	reader, err := notebook.NewReader(cfg.Notebooks.StoriesDirectories, cfg.Notebooks.FlashcardsDirectories, cfg.Notebooks.BooksDirectories, cfg.Notebooks.DefinitionsDirectories, cfg.Notebooks.EtymologyDirectories, nil)
	if err != nil {
