...
type SubmitAnswerResponse struct {
	...
	// part_of_speech is the sense discriminator of the just-written learning
	// log. The frontend echoes it back on OverrideAnswer/UndoOverrideAnswer so
	// the override targets the correct sense of a homograph (e.g. "record" the
	// noun vs the verb). Empty for single-sense / legacy words.
...
func (x *SubmitAnswerResponse) GetPartOfSpeech() string {
	if x != nil {
		return x.PartOfSpeech
	}
	return ""
...
type SubmitReverseAnswerResponse struct {
	...
	// part_of_speech: see SubmitAnswerResponse.part_of_speech.
	PartOfSpeech  string `protobuf:"bytes,11,opt,name=part_of_speech,json=partOfSpeech,proto3" json:"part_of_speech,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubmitReverseAnswerResponse) GetPartOfSpeech() string {
	if x != nil {
		return x.PartOfSpeech
	}
	return ""
...
type SubmitFreeformAnswerResponse struct {
	...
	// part_of_speech: see SubmitAnswerResponse.part_of_speech.
	PartOfSpeech  string `protobuf:"bytes,12,opt,name=part_of_speech,json=partOfSpeech,proto3" json:"part_of_speech,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubmitFreeformAnswerResponse) GetPartOfSpeech() string {
	if x != nil {
		return x.PartOfSpeech
	}
	return ""
...
type OverrideAnswerRequest struct {
	...
	// part_of_speech identifies which sense of a homograph the override
	// targets. Echoed from the Submit*Response the frontend rendered. Empty
	// matches the legacy/unspecified sense so pre-change data still overrides.
...
func (x *OverrideAnswerRequest) GetPartOfSpeech() string {
	if x != nil {
		return x.PartOfSpeech
	}
	return ""
...
type UndoOverrideAnswerRequest struct {
	...
	// part_of_speech: see OverrideAnswerRequest.part_of_speech.
	PartOfSpeech  string `protobuf:"bytes,8,opt,name=part_of_speech,json=partOfSpeech,proto3" json:"part_of_speech,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UndoOverrideAnswerRequest) GetPartOfSpeech() string {
	if x != nil {
		return x.PartOfSpeech
	}
	return ""
...
const file_api_v1_quiz_proto_rawDesc = "" +
	...
	"\n" +
	"is_skipped\x18\x04 \x01(\bR\tisSkipped\"\x9e\x02\n" +
	...
	"\x0epart_of_speech\x18\b \x01(\tR\fpartOfSpeech\"\\\n" +
	...
	"\n" +
	"is_skipped\x18\x05 \x01(\bR\tisSkipped\"\x89\x03\n" +
	...
	"\x06images\x18\n" +
	" \x03(\tR\x06images\x12$\n" +
	"\x0epart_of_speech\x18\v \x01(\tR\fpartOfSpeech\"j\n" +
	...
	"\x0epart_of_speech\x18\f \x01(\tR\fpartOfSpeech\"\xb3\x02\n" +
	...
	"\x10next_review_date\x18\x05 \x01(\tH\x01R\x0enextReviewDate\x88\x01\x01\x12$\n" +
	"\x0epart_of_speech\x18\x06 \x01(\tR\fpartOfSpeechB\x0f\n" +
	"\r_mark_correctB\x13\n" +
	...
	"\x16original_interval_days\x18\x04 \x01(\x05R\x14originalIntervalDaysJ\x04\b\x05\x10\x06\"\xca\x02\n" +
	...
	"\x16original_interval_days\x18\x06 \x01(\x05R\x14originalIntervalDays\x12$\n" +
	"\x0epart_of_speech\x18\b \x01(\tR\fpartOfSpeechJ\x04\b\a\x10\b\"`\n" +
...
var file_api_v1_quiz_proto_depIdxs = []int32{
	...
	4,  // 46: api.v1.QuizService.GetQuizOptions:input_type -> api.v1.GetQuizOptionsRequest
	9,  // 47: api.v1.QuizService.StartQuiz:input_type -> api.v1.StartQuizRequest
	15, // 48: api.v1.QuizService.SubmitAnswer:input_type -> api.v1.SubmitAnswerRequest
	17, // 49: api.v1.QuizService.BatchSubmitAnswers:input_type -> api.v1.BatchSubmitAnswersRequest
	19, // 50: api.v1.QuizService.StartReverseQuiz:input_type -> api.v1.StartReverseQuizRequest
	23, // 51: api.v1.QuizService.SubmitReverseAnswer:input_type -> api.v1.SubmitReverseAnswerRequest
	25, // 52: api.v1.QuizService.BatchSubmitReverseAnswers:input_type -> api.v1.BatchSubmitReverseAnswersRequest
	27, // 53: api.v1.QuizService.StartFreeformQuiz:input_type -> api.v1.StartFreeformQuizRequest
	29, // 54: api.v1.QuizService.SubmitFreeformAnswer:input_type -> api.v1.SubmitFreeformAnswerRequest
	31, // 55: api.v1.QuizService.OverrideAnswer:input_type -> api.v1.OverrideAnswerRequest
	33, // 56: api.v1.QuizService.UndoOverrideAnswer:input_type -> api.v1.UndoOverrideAnswerRequest
	35, // 57: api.v1.QuizService.SkipWord:input_type -> api.v1.SkipWordRequest
	37, // 58: api.v1.QuizService.ResumeWord:input_type -> api.v1.ResumeWordRequest
	43, // 59: api.v1.QuizService.StartEtymologyQuiz:input_type -> api.v1.StartEtymologyQuizRequest
	45, // 60: api.v1.QuizService.SubmitEtymologyStandardAnswer:input_type -> api.v1.SubmitEtymologyStandardAnswerRequest
	47, // 61: api.v1.QuizService.BatchSubmitEtymologyStandardAnswers:input_type -> api.v1.BatchSubmitEtymologyStandardAnswersRequest
	49, // 62: api.v1.QuizService.SubmitEtymologyReverseAnswer:input_type -> api.v1.SubmitEtymologyReverseAnswerRequest
	51, // 63: api.v1.QuizService.BatchSubmitEtymologyReverseAnswers:input_type -> api.v1.BatchSubmitEtymologyReverseAnswersRequest
	53, // 64: api.v1.QuizService.StartEtymologyFreeformQuiz:input_type -> api.v1.StartEtymologyFreeformQuizRequest
	55, // 65: api.v1.QuizService.SubmitEtymologyFreeformAnswer:input_type -> api.v1.SubmitEtymologyFreeformAnswerRequest
