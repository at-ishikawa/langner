          ...
          {loading ? (<Box textAlign="center" py={8}><Spinner size="lg" mb={4} /><Text>Checking your answer...</Text></Box>
            ...
            <>
              ...
              <FeedbackActions isCorrect={displayCorrect} noteId={feedback.noteId} isOverridden={overridden} isSkipped={skipped}
                ...
                onOverride={feedback.noteId ? async () => { try { await quizClient.overrideAnswer({ noteId: feedback.noteId!, quizType: ProtoQuizType.ETYMOLOGY_REVERSE, learnedAt: feedback.learnedAt!, markCorrect: !displayCorrect }); setOverridden(true); setDisplayCorrect(!displayCorrect); } catch {} } : undefined}
