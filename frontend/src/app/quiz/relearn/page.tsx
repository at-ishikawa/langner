...
export default function RelearnStartPage() {
    ...
    <Box maxW="sm" mx="auto" bg="gray.50" _dark={{ bg: "gray.900" }} minH="100vh">
      <Box bg="white" _dark={{ bg: "gray.800", borderColor: "gray.600" }} borderBottomWidth="1px" borderColor="gray.200">
        ...
        <Box px={4} pb={3} textAlign="center">
          <Heading size="md">Relearn Quiz</Heading>
        </Box>
      </Box>

      <Box p={4}>
        <Text fontSize="sm" color="gray.600" _dark={{ color: "gray.300" }} mb={4}>
          Practice the words you recently got wrong. Nothing here is saved to your history or schedule.
        </Text>
